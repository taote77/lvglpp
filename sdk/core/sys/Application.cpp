...
{
    auto path             = boost::dll::program_location().parent_path(); // boost::filesystem::initial_path<boost::filesystem::path>();
    ...
    file_assert_fs_drv_.open_cb    = [](struct _lv_fs_drv_t *drv, const char *path, lv_fs_mode_t mode) -> void    *{
    ...
    file_assert_fs_drv_.read_cb = [](struct _lv_fs_drv_t *drv, void *file_p, void *buf, uint32_t btr, uint32_t *br) -> lv_fs_res_t {
        if (file_p == nullptr)
        {
            return LV_FS_RES_FS_ERR;
        }
    ...
    file_assert_fs_drv_.write_cb = [](struct _lv_fs_drv_t *drv, void *file_p, const void *buf, uint32_t btw, uint32_t *bw) -> lv_fs_res_t {
        if (file_p == nullptr)
        {
            return LV_FS_RES_FS_ERR;
        }
    ...
    file_assert_fs_drv_.tell_cb = [](struct _lv_fs_drv_t *drv, void *file_p, uint32_t *pos_p) -> lv_fs_res_t {
        if (file_p == nullptr)
        {
            return LV_FS_RES_FS_ERR;
        }
    ...
    file_assert_fs_drv_.seek_cb = [](struct _lv_fs_drv_t *drv, void *file_p, uint32_t pos, lv_fs_whence_t whence) -> lv_fs_res_t {
        if (file_p == nullptr)
        {
            return LV_FS_RES_FS_ERR;
        }
    ...
    mem_assert_fs_drv_.open_cb    = [](struct _lv_fs_drv_t *drv, const char *path, lv_fs_mode_t mode) -> void    *{
    ...
    mem_assert_fs_drv_.read_cb = [](struct _lv_fs_drv_t *drv, void *file_p, void *buf, uint32_t btr, uint32_t *br) -> lv_fs_res_t {
        auto *info = (tools::ResourceInfo *)file_p;
        if (info == nullptr)
        {
            return LV_FS_RES_FS_ERR;
    ...
    mem_assert_fs_drv_.write_cb = [](struct _lv_fs_drv_t *drv, void *file_p, const void *buf, uint32_t btw, uint32_t *bw) -> lv_fs_res_t { return LV_FS_RES_NOT_IMP; };
    mem_assert_fs_drv_.tell_cb  = [](struct _lv_fs_drv_t *drv, void *file_p, uint32_t *pos_p) -> lv_fs_res_t {
        auto *info = (tools::ResourceInfo *)file_p;
        if (info == nullptr)
        {
            return LV_FS_RES_FS_ERR;
    ...
    mem_assert_fs_drv_.seek_cb = [](struct _lv_fs_drv_t *drv, void *file_p, uint32_t pos, lv_fs_whence_t whence) -> lv_fs_res_t {
        auto *info = (tools::ResourceInfo *)file_p;
        if (file_p == nullptr)
        {
            return LV_FS_RES_FS_ERR;
