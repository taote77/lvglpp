...
{
    auto it = sender->signals.find(signal_name);
    if (it != sender->signals.end())
    {
    ...
    } else
    {
        ...
        sender->signals[signal_name] = newSignal;
    }
}

void Object::connect(Object *sender, const std::string &signal_name, const Object *receiver, const Slot &slot)
{
    auto it = sender->signals.find(signal_name);
    if (it != sender->signals.end())
    {
