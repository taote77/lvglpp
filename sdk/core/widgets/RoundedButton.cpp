...
namespace heygears
{
    namespace widgets
    {
        ...
        RoundedButton::RoundedButton(int width, int height, RoundedButton::ColorStyle type, const std::string &strMsg,
                                     BaseItem *parent) : BaseItem(parent), type_(type)
        {
        ...
        RoundedButton::RoundedButton(int width, int height, RoundedButton::ColorStyle type, const std::string &strMsg,
                                     const std::string &strImgPath, BaseItem *parent) : BaseItem(parent), type_(type)
        {
            init(width, height, type);
        ...
        void RoundedButton::initLabel(const std::string &msg, RoundedButton::ColorStyle type)
        {
            ...
            label_.reset(new ConsumeText(msg, CLR_PRIMARY_BLACK, this, ConsumeText::FontSize24));
