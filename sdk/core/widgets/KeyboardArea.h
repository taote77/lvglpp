#ifndef LV_KEYBOARD_AREA_H
#define LV_KEYBOARD_AREA_H
...
class KeyboardArea : public BaseItem
{
public:
    explicit KeyboardArea(BaseItem *parent = nullptr);
