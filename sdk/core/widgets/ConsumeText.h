#ifndef LVGLPP_CONSUMETEXT_H
#define LVGLPP_CONSUMETEXT_H
...
public:
    ...
    ConsumeText(const std::string &strMsg, uint32_t clr, BaseItem *parent, TextStyle style = TextStyle::FontSize20, FontType type = FontType::Auto);
    ...
    void setLongMode(int mode = 1); // 1-LV_LABEL_LONG_BREAK, 2-LV_LABEL_LONG_SCROLL
