...
static lv_obj_t *card_labels_create(lv_obj_t *parent, const char *value, const char *unit,
                                    const char *title);
...
static lv_obj_t *info_box_create(lv_obj_t *parent, const void *icon, const char *big_text,
...
static lv_obj_t *left_cont_create(lv_obj_t *parent)
{
    ...
    lv_obj_set_flex_align(top_cont, LV_FLEX_ALIGN_SPACE_BETWEEN, LV_FLEX_ALIGN_CENTER,
    ...
    lv_subject_add_observer_obj(&ebike_subject_speed_roller, speed_roller_10_observer_cb, roller_1,
                                NULL);
    ...
    lv_subject_add_observer_obj(&ebike_subject_speed_roller, speed_roller_1_observer_cb, roller_10,
                                NULL);
...
static lv_obj_t *bullets_create(lv_obj_t *parent)
{
    ...
    static const lv_style_prop_t props[] = { LV_STYLE_BG_OPA, LV_STYLE_TRANSFORM_HEIGHT,
                                             LV_STYLE_TRANSFORM_WIDTH, LV_STYLE_PROP_INV };
...
static lv_obj_t *right_cont_create(lv_obj_t *parent)
{
    ...
    lv_obj_set_flex_flow(right_cont,
                         LV_DEMO_EBIKE_PORTRAIT ? LV_FLEX_FLOW_ROW : LV_FLEX_FLOW_COLUMN);
