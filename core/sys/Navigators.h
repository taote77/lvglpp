...
Description:应用程序页面管理类

**************************************************************************/

#ifndef HEYGEARS_LVGL_DEMO_NAVIGATORS_H
#define HEYGEARS_LVGL_DEMO_NAVIGATORS_H
...
public:
    ...
    Activity *getRootActivity() const
    {
        if (view_manager_.empty()) {
            return nullptr;
        } else {
            return view_manager_[0].get();
        }
    }
...
#endif // HEYGEARS_LVGL_DEMO_NAVIGATORS_H
