...
namespace widgets {
        ...
        static const lv_ft_info_t &getFontByStyle(ConsumeText::TextStyle style, ConsumeText::FontType type)
        {
            ...
            switch (style)
            {
                ...
                case ConsumeText::TextStyle::Subheading2:
...
static const lv_font_t *getFontByStyle(ConsumeText::TextStyle style, ConsumeText::FontType type)
{
    ...
    case ConsumeText::TextStyle::ParagraphBold:
        return tools::LvFontManager::getFontInfo(font_type, 16, tools::LvFontManager::Bold);
    case ConsumeText::TextStyle::Custom18:
        return tools::LvFontManager::getFontInfo(font_type, 18, tools::LvFontManager::Normal);
    case ConsumeText::TextStyle::Custom48Bold:
    ...
    case ConsumeText::TextStyle::Custom64Bold:
        return tools::LvFontManager::getFontInfo(font_type, 64, tools::LvFontManager::Bold);
    case ConsumeText::TextStyle::Custom72Bold:
        return tools::LvFontManager::getFontInfo(font_type, 72, tools::LvFontManager::Bold);
    case ConsumeText::TextStyle::Custom120Bold:
        return tools::LvFontManager::getFontInfo(font_type, 120, tools::LvFontManager::Bold);
    default:
        return tools::LvFontManager::getFontInfo(font_type, 16, tools::LvFontManager::Normal);
    }
}
...
void ConsumeText::setAligmentTo(const BaseItem &item, lv_align_t align, lv_coord_t offsetX,
                                lv_coord_t offsetY)
{
    if (heygears::sys::Application::getLanguageType() != sys::Application::English
        || font_type_ == FontType::SansSC) {
...
ConsumeText::ConsumeText(const std::string &strMsg, uint32_t clr, BaseItem *parent,
                         ConsumeText::TextStyle style, FontType type)
